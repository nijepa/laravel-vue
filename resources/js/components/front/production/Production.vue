    ...
    <div class="card m-2">
        ...
        <div class="card-body" v-for="productions in allProduction" :key="productions.id">
            ...
            <ul style="text-align: justify;">
                ...
                <li class="style1">elementi za nameštaj</li>
                <li class="style1">kuhinje, sobe, kupatila ...</li>
                <li class="style1">opremanje enterijera</li>
                <li class="style1">program etno nameštaja</li>
                <li>jedinstvene ručice za nameštaj, kuhinje, kamine i peći</li>
            </ul>
